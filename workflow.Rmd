...
```{r}
readr::write_csv(richness_forecast, "products/richness_forecast.csv")
readr::write_csv(abund_forecast, "products/abund_forecast.csv")
...
abund_score <- score(abund_forecast, true_abund)
```
