...
2. Clean / process data into (a) richness and (b) catch-per-unit-effort (CPUE) data products which teams will seek to predict future values for
...
Our first product is the derived data for `richness` and `cpue`.  We write the files to disk and publish them under 
