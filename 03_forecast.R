...
readr::write_csv(richness_forecast, file.path(base, "forecasts/beetle-richness-forecast-team_null_average.csv.gz"))
readr::write_csv(abund_forecast,  file.path(base, "forecasts/beetle-abund-forecast-team_null_average.csv.gz"))

## Really a forecast should have EML metadata too.
## We also want to publish these benchmark forecasts
